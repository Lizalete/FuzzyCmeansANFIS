...
namespace SharpGLWinformsApplication1
{
    ...
    public partial class SharpGLForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            gamma = Double.Parse(TXT_GAMMA.Text);
            tau = int.Parse(TXT_TAU.Text);
            numberOfPoints = int.Parse(TXT_N.Text) + 100;
            power = int.Parse(TXT_POW.Text);
            
            mackey = MackeyGlass.FILL(beta,gamma,tau,numberOfPoints,power);            
        }

        private void button1_Click_1(object sender, EventArgs e)
        {
            thread = new Thread(Clusterize);
            thread.Start();
        }
        ...
        {
            string[] lines = System.IO.File.ReadAllLines(@"-100.txt");
